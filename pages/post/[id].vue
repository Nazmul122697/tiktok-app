  ...
  >
    ...
    >
      ...
      <div class="flex items-center px-8 mt-8">
        ...
        <div class="pl-2 pr-4 text-xs font-semibold text-gray-800">
            123
        </div>
        <div class="flex items-center pb-4 text-center">
      ...
      <div id="comments" class="bg-[#F8f8f8] z-0 h-[calc(100%-273px)] border-t-2 overflow-auto">
        <div class="pt-2" />
        ...
        <div v-else class="relative flex justify-between px-8 mt-4">
            <div class="relative flex items-center w-full">
                <nuxt-link to="">
                    <img class="absolute top-0 mx-auto rounded-full lg:mx-0" width="40" 
                    src="https://picsum.photos/id/8/300/320"
                    />
                </nuxt-link>
